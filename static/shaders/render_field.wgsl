// ============================================================================
// Fullscreen Field View Renderer (ADR-0005) — Scalar field visualization
//
// Samples the scalar field storage buffer with manual bilinear filtering,
// maps values through a colormap LUT texture, and renders solid cells as
